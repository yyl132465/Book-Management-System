    ...
    <el-card class="login-card" :style="cardStyle">
      ...
      <el-form :model="form" :rules="rules" ref="formRef" label-width="0">
        ...
        <el-form-item prop="r_name">
          <el-input v-model="form.r_name" placeholder="姓名" prefix-icon="Edit" size="large" />
        </el-form-item>
        <el-form-item prop="class">
          <el-input v-model="form.class" placeholder="班级" prefix-icon="School" size="large" />
        </el-form-item>
        <el-form-item prop="phone">
          <el-input v-model="form.phone" placeholder="电话（选填）" prefix-icon="Phone" size="large" />
        </el-form-item>
      ...
      <div class="footer-link">
        <router-link to="/reader/login">已有账号？去登录</router-link>
      </div>
    </el-card>
  </div>
</template>
